use crate::{
    asset_loading, assets::GameAssets, audio::GameAudio, cleanup, component_adder::AnimationLink,
    ...
    fn build(&self, app: &mut App) {
        app.add_system_set(
            SystemSet::on_update(AppState::Cutscene)
                ...
                .with_system(move_camera), //           .with_system(game_camera::pan_orbit_camera)
        )
        .add_system_set(SystemSet::on_update(AppState::InGame).with_system(handle_cutscene_event))
        .add_event::<CutsceneEvent>()
        .insert_resource(TextBox::default())
        .add_system_set(
            SystemSet::on_enter(AppState::Cutscene)
...
fn play_cutscene(
    ...
    if cutscene_state.waiting_on_input {
        return;
    }
    ...
    if let Some(current) = cutscene_state.current {
        *ingame_ui_textbox = ingame_ui::TextBox::default(); // clear out any banter or commentary
        match current {
            Cutscene::LevelTwoIntro => match cutscene_state.cutscene_index {
                0 => {
                ...
                4 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "But, we're ready now. We have popcorn. Let's get started!"
                            .to_string(),
                        speed: text_speed,
                        auto: false,
                        speaking: DisplayCharacter::Bill,
            ...
            Cutscene::LevelThreeIntro => match cutscene_state.cutscene_index {
                0 => {
                    camera.translation = Vec3::new(22.5, 1.5, 0.0);
                    camera.rotation = Quat::from_axis_angle(
                        Vec3::new(-0.034182332, -0.9987495, -0.03648749),
                ...
                10 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "They'll be illuminated only by the lights tracking them."
                            .to_string(),
                        speed: text_speed,
                        auto: false,
                        speaking: DisplayCharacter::Bill,
                ...
                11 => {
                    textbox.queued_text = Some(TextBoxText {
                        text:
                            "Dealing with these last-minute adjustments is part of the challenge!"
                                .to_string(),
                        speed: text_speed,
                        auto: false,
                        speaking: DisplayCharacter::Bill,
            ...
            Cutscene::Intro => match cutscene_state.cutscene_index {
                ...
                12 => {
                    textbox.queued_text = Some(TextBoxText {
                        text:
                            "Bill, I lost my notes, can you tell our viewers what it's all about?"
                                .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Will,
                ...
                15 => {
                    cutscene_state.target_camera_translation =
                        Some((Vec3::new(-18.6, 6.5, 16.041729)));
                    cutscene_state.target_camera_rotation = Some(Quat::from_axis_angle(
                        Vec3::new(-0.5818577, -0.7968926, -0.1624936),
                        0.6599797,
                    ));
                    textbox.queued_text = Some(TextBoxText {
                ...
                16 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "We've been generously donated 1,000 acres worth of corn."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                22 => {
                    ...
                    cutscene_state.target_camera_rotation = Some(Quat::from_axis_angle(
                        Vec3::new(-0.07643463, -0.9914023, -0.10620499),
                        1.8807149,
                    ));
                ...
                23 => {
                    ...
                    cutscene_state.target_camera_rotation = Some(Quat::from_axis_angle(
                        Vec3::new(-0.50110954, -0.84660023, -0.17932819),
                        0.78708464,
                    ));
                ...
                31 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "And if they get tackled, they'll have to go back to the goal line."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                35 => {
                    ...
                    cutscene_state.target_camera_rotation = Some(Quat::from_axis_angle(
                        Vec3::new(-0.09976758, -0.9702991, -0.22037746),
                        2.3035543,
                    ));
                ...
                36 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "Don't worry though, we have a professional driver in the combine."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                39 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "We have an ambulance on site. And the players have signed waivers."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                41 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "The round ends once the combine has completely harvested the maze."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                42 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "Then, we'll have our team re-plant the maze for the next round."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                45 => {
                    textbox.queued_text = Some(TextBoxText {
                        text:
                            "We know we have players with different preferences on how to compete."
                                .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                49 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "Ha ha, Will, football is played a little different these days."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                51 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "Actually, this always bugged me.. why is it called \"Combine\"?"
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Will,
                ...
                53 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "and then one year they decided to combine them into one."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                55 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "ha... yeah.. I uhh.. that's what it's called, man, I don't know."
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
                ...
                56 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "Oh, the kicker is ready, I think it's about to begin. Let's watch!"
                            .to_string(),
                        speed: text_speed,
                        auto: true,
                        speaking: DisplayCharacter::Bill,
            ...
            Cutscene::Tackle => match cutscene_state.cutscene_index {
                0 => {
                    camera.translation = Vec3::new(19.3, 1.5, 0.0);
                    camera.rotation = Quat::from_axis_angle(
                        Vec3::new(-0.034182332, -0.9987495, -0.03648749),
            ...
            Cutscene::RoundOneOver => match cutscene_state.cutscene_index {
                0 => {
                    camera.translation = Vec3::new(19.3, 1.5, 0.0);
                    camera.rotation = Quat::from_axis_angle(
                        Vec3::new(-0.034182332, -0.9987495, -0.03648749),
            ...
            Cutscene::RoundTwoOver => match cutscene_state.cutscene_index {
                0 => {
                    camera.translation = Vec3::new(19.3, 1.5, 0.0);
                    camera.rotation = Quat::from_axis_angle(
                        Vec3::new(-0.034182332, -0.9987495, -0.03648749),
            ...
            Cutscene::RoundThreeOver => match cutscene_state.cutscene_index {
                0 => {
                    camera.translation = Vec3::new(19.3, 1.5, 0.0);
                    camera.rotation = Quat::from_axis_angle(
                        Vec3::new(-0.034182332, -0.9987495, -0.03648749),
                ...
                2 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "Are these taking longer? We got through three rounds today."
                            .to_string(),
                        speed: text_speed,
                        auto: false,
                        speaking: DisplayCharacter::Bill,
                ...
                5 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "I.. I don't think this is the best event for the Combine."
                            .to_string(),
                        speed: text_speed,
                        auto: false,
                        speaking: DisplayCharacter::Will,
                ...
                12 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "Anyway! If you're still out there, thanks for sticking around."
                            .to_string(),
                        speed: text_speed,
                        auto: false,
                        speaking: DisplayCharacter::Bill,
                ...
                13 => {
                    textbox.queued_text = Some(TextBoxText {
                        text: "We're going to have some internal meetings to tweak this event."
                            .to_string(),
                        speed: text_speed,
                        auto: false,
                        speaking: DisplayCharacter::Bill,
            ...
            Cutscene::Death => match game_state.death_count {
                1 => match cutscene_state.cutscene_index {
                    0 => {
                        camera.translation = Vec3::new(19.3, 1.5, 0.0);
                        camera.rotation = Quat::from_axis_angle(
                            Vec3::new(-0.034182332, -0.9987495, -0.03648749),
                ...
                2 => match cutscene_state.cutscene_index {
                    0 => {
                        camera.translation = Vec3::new(19.3, 1.5, 0.0);
                        camera.rotation = Quat::from_axis_angle(
                            Vec3::new(-0.034182332, -0.9987495, -0.03648749),
                ...
                3 => match cutscene_state.cutscene_index {
                    0 => {
                        camera.translation = Vec3::new(19.3, 1.5, 0.0);
                        camera.rotation = Quat::from_axis_angle(
                            Vec3::new(-0.034182332, -0.9987495, -0.03648749),
                ...
                _ => match cutscene_state.cutscene_index {
                    0 => {
                        camera.translation = Vec3::new(19.3, 1.5, 0.0);
                        camera.rotation = Quat::from_axis_angle(
                            Vec3::new(-0.034182332, -0.9987495, -0.03648749),
...
fn move_camera(
    ...
    if let Some(target) = cutscene_state.target_camera_translation {
        ...
        camera.translation += (target - camera_translation)
            * (time.delta_seconds() * cutscene_state.camera_speed.max(0.1));
    }
    if let Some(target) = cutscene_state.target_camera_rotation {
        let mut camera = camera.single_mut();
        let new_rotation = camera.rotation.lerp(
            target,
            time.delta_seconds() * cutscene_state.camera_speed.max(0.1),
        );
...
fn queue_initial_text(mut textbox: ResMut<TextBox>) {
...
fn display_textbox(
    ...
    if let Ok(container) = text_container.get_single() {
        if let Some(current_text) = &mut textbox.queued_text {
            ...
            let text_to_display: String = if let Some(space_index) = maybe_space_index {
...
fn handle_input(
    ...
    if cutscene_state.input_cooldown > 0.0 {
        return;
    }
