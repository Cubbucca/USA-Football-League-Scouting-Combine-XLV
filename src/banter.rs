use crate::{
    assets::GameAssets, cleanup, component_adder::AnimationLink, game_camera, game_state, ingame,
    ingame_ui, menus, other_persons, ui::text_size, AppState,
};
use bevy::prelude::*;
use rand::Rng;
...
impl Plugin for BanterPlugin {
    fn build(&self, app: &mut App) {
        app.add_system_set(SystemSet::on_update(AppState::InGame).with_system(send_banter))
...
fn send_banter(
    ...
    if banter_state.banters.is_empty() {
        return;
    }
